                    ...
                    notify.data.map((msg, index) => (
                        <div key={index} className="px-2 mb-3" >
                            ...
                            onClick={() => handleIsRead(msg)}>
                                <img src={msg.user.avatar} alt="big-avatar" style={{width:"60px", height:"60px", borderRadius:"9999px"}} />
                                    ...
                                    <div style={{width: '30px'}}>
                                        {
                                            ...
                                            : <img src={msg.image} alt="medium-avatar" style={{width:"60px", height:"60px"}} />
                                        }
                                    </div>
                                }
